...
export default function LogIn({ navigate, changeView }) {
  const { handleChange, handleSubmit } = useContext(userContext);

  return (
    <div className="w-full md:w-3/5 h-full bg-white flex flex-col ">
      <nav className="flex justify-center mt-4">
        <ul className="flex font-poppins justify-evenly w-full text-xs md:text-sm">
          <li>Colection</li>
          <li>Record</li>
          <li>Listen Your Token</li>
        </ul>
      </nav>
      <div className="w-[90%] max-w-[350px] font-poppins mx-auto my-auto h-4/5 md:h-3/5">
        <h1 className="text-3xl tracking-wider font-bold ">Log In</h1>
        <form
          onSubmit={handleSubmit}
          className="h-[90%] flex flex-col my-5 justify-center gap-6"
        >
          ...
          <div className="w-full flex justify-between text-[15px] md:text-sm">
            <span>
              {" "}
          ...
          <div className="text-center w-[90%] mx-auto">
            <span
              className='relative before:content-[""] before:top-[0.6em] after:left-[4.4em] before:right-[4.4em] after:top-[0.6em]  before:absolute before:w-[80px] before:h-[2px] before:bg-gray-500
                    after:content-[""] after:absolute after:w-[80px] after:h-[2px] after:bg-gray-500 cursor-pointer'
              onClick={changeView}
            >
              Register
            </span>
